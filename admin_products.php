    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="admin_products.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Tem mesmo acerteza de que quer apagar esse produto!');" style="margin-bottom:10px; background-color:#fff;color:#000;" >Apagar</a>
            </div>
            <?php
             }
            }else {
